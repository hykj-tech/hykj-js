...
// 是否浏览器
export const platformIsBrowser = Platform === EPlatform.H5
// 是否是app
export const platformIsApp = Platform === EPlatform.AppPlus || Platform === EPlatform.AppPlusNvue
// 是否是小程序
export const platformIsMp = Platform === EPlatform.Mp || Platform === EPlatform.MpWeixin || Platform === EPlatform.MpAlipay || Platform === EPlatform.MpBaidu || Platform === EPlatform.MpToutiao || Platform === EPlatform.MpQq || Platform === EPlatform.Mp360
